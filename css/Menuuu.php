...
<main class="site-wrapper">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                <div class="page-title  home text-center">
                                  <span class="heading-page"> Welcome to BloodConect
                                    <p class="mt20">
 ...
 <div class="hexagon-menu clear">
    <div class="hexagon-item">
        <a href="Home.php" class="hex-content <?php echo ($_SESSION["tab"] == "Home") ? 'active' : ''; ?>">
            <span class="hex-content-inner">
                <span class="icon">
	...
	<div class="hexagon-item">
        ...
        <a href="Add User.php" class="hex-content <?php echo ($_SESSION["tab"] == "Add User") ? 'active' : ''; ?>">
            <span class="hex-content-inner">
                <span class="icon">
                    <i class="fa fa-home"></i> 
                </span>
